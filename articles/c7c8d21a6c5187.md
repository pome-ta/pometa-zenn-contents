...
iPhone, iPad の無料アプリ[a-Shell](https://holzschu.github.io/a-Shell_iOS/) を使って、[UIKit](https://developer.apple.com/jp/documentation/uikit/) を呼び出しアプリを制作します。
Swift, Objective-C ではなく Python で実装します。
