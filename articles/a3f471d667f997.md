...
Rubicon-ObjC で実装するにあたり、[Apple Developer Documentation](https://developer.apple.com/documentation) は必須と言っても過言ではありません。
...
[NSSetUncaughtExceptionHandler](https://developer.apple.com/documentation/foundation/1409609-nssetuncaughtexceptionhandler?language=objc) の場合は、`Function` です。確認する点も含めて整理していきます。
![todo: iPhone のスクリーンショットに差し替え予定 Image](https://github.com/user-attachments/assets/6fbb14f6-0794-4345-b0f6-62de8822a6f7)

Objective-C からRubicon-ObjC を宣言する中で
