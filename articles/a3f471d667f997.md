...
それ以外のFramework は、[`load_library`](https://rubicon-objc.readthedocs.io/en/stable/reference/rubicon-objc-runtime.html#rubicon.objc.runtime.load_library) から、自身でload する必要があります。

続いて引数の型と、返り値の型を確認し`restype` と`argtypes` を定義します。
