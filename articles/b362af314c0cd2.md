---
title: '【アプリ制作編】#3: a-Shell(mini) の Python で UIKit から View を呼び出す【Rubicon-ObjC】'
emoji: '🧳'
type: 'tech'
...
今回の View の表示結果は、前回と変わりありません。1 ファイル(`singleFileSample.py`)だったコードを module 化し、煩雑さの回避、取り回しをよくするのが目的です。
今後訪れるアプリ開発においても、実装したいコードに集中できる利点もあります。

![image](https://github.com/user-attachments/assets/d03ba5d8-9fe3-4f15-8126-250d70b92f62)

分割作業と同時にコードの説明をします。不明瞭な部分の解決に繋がれば幸いです。
