...
[a-Shell](https://holzschu.github.io/a-Shell_iOS/) のPython から使って、[UIKit](https://developer.apple.com/jp/documentation/uikit/) を呼び出し、アプリをつくります。
:::message
App Store へ公開はできません
:::


[SF Symbols](https://developer.apple.com/jp/sf-symbols/) の一覧を出す簡単なアプリを実装します。
